...
public class TunnelElevationInterpolatorTest extends AbstractEdgeElevationInterpolatorTest {
    ...
    public void doesNotInterpolateElevationOfTunnelWithZeroOuterNodes() {
        ...
        edge01.setFlags(dataFlagEncoder.handleWayTags(interpolatableWay, EncodingManager.Access.WAY, 0));
        edge12.setFlags(dataFlagEncoder.handleWayTags(interpolatableWay, EncodingManager.Access.WAY, 0));
        edge34.setFlags(dataFlagEncoder.handleWayTags(interpolatableWay, EncodingManager.Access.WAY, 0));
    ...
    public void interpolatesElevationOfTunnelWithTwoOuterNodes() {
        ...
        edge12.setFlags(dataFlagEncoder.handleWayTags(interpolatableWay, EncodingManager.Access.WAY, 0));
        edge23.setFlags(dataFlagEncoder.handleWayTags(interpolatableWay, EncodingManager.Access.WAY, 0));
    ...
    public void interpolatesElevationOfTunnelWithThreeOuterNodes() {
        ...
        edge23.setFlags(dataFlagEncoder.handleWayTags(interpolatableWay, EncodingManager.Access.WAY, 0));
        edge34.setFlags(dataFlagEncoder.handleWayTags(normalWay, EncodingManager.Access.WAY, 0));
        edge25.setFlags(dataFlagEncoder.handleWayTags(interpolatableWay, EncodingManager.Access.WAY, 0));
        edge56.setFlags(dataFlagEncoder.handleWayTags(interpolatableWay, EncodingManager.Access.WAY, 0));
        edge67.setFlags(dataFlagEncoder.handleWayTags(normalWay, EncodingManager.Access.WAY, 0));
