...
public class GraphHopperStorageLMTest {
    ...
    public void testLoad() {
        ...
        graph.getEdgeIteratorState(0, 1).setFlags(carFlagEncoder.handleWayTags(way_0_1, EncodingManager.Access.WAY, 0));
        ...
        graph.getEdgeIteratorState(1, 2).setFlags(carFlagEncoder.handleWayTags(way_1_2, EncodingManager.Access.WAY, 0));
