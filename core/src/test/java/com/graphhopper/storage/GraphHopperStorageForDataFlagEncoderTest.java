...
public class GraphHopperStorageForDataFlagEncoderTest {
    ...
    public void testStorageProperties() {
        ...
        graph.getEdgeIteratorState(0, 1).setFlags(encoder.handleWayTags(way_0_1, EncodingManager.Access.WAY, 0));
        ...
        graph.getEdgeIteratorState(1, 2).setFlags(encoder.handleWayTags(way_1_2, EncodingManager.Access.WAY, 0));
        ...
        graph.getEdgeIteratorState(2, 0).setFlags(encoder.handleWayTags(way_2_0, EncodingManager.Access.WAY, 0));
