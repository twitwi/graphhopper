...
public class DataFlagEncoderTest {
    ...
    public void testHighway() {
        ...
        long flags = encoder.handleWayTags(osmWay, EncodingManager.Access.WAY, 0);
        ...
        flags = encoder.handleWayTags(osmWay, EncodingManager.Access.WAY, 0);
    ...
    public void testDestinationTag() {
        ...
        assertEquals(SpatialRule.Access.YES, encoder.getAccessValue(encoder.handleWayTags(way, encoder.getAccess(way), 0)));

        way.setTag("vehicle", "destination");
        assertEquals(SpatialRule.Access.CONDITIONAL, encoder.getAccessValue(encoder.handleWayTags(way, encoder.getAccess(way), 0)));

        way.setTag("vehicle", "no");
        assertEquals(SpatialRule.Access.NO, encoder.getAccessValue(encoder.handleWayTags(way, encoder.getAccess(way), 0)));
    }
    ...
    public void testSpatialId() {
        ...
        e1.setFlags(encoder.handleWayTags(way, EncodingManager.Access.WAY, 0));
        e2.setFlags(encoder.handleWayTags(way2, EncodingManager.Access.WAY, 0));
        e3.setFlags(encoder.handleWayTags(livingStreet, EncodingManager.Access.WAY, 0));
        e4.setFlags(encoder.handleWayTags(livingStreet2, EncodingManager.Access.WAY, 0));
