...
public class GenericWeightingTest {
    ...
    public void setUp() {
        ...
        graph.getEdgeIteratorState(0, 1).setFlags(encoder.handleWayTags(way, EncodingManager.Access.WAY, 0));
    }
    ...
    public void testDisabledRoadAttributes() {
        ...
        simpleGraph.getEdgeIteratorState(0, 1).setFlags(simpleEncoder.handleWayTags(way, EncodingManager.Access.WAY, 0));
